...
Use the following information to understand how to create your document:
    - create your file under `docs/handoffs/{ticket}/YYYY-MM-DD_HH-MM-SS_{ticket}_description.md`, where:
    ...
    - Gather metadata using bash commands:
        - `date -u +"%Y-%m-%dT%H:%M:%SZ"` for ISO timestamp
    ...
    - Examples:
        - With ticket: `docs/handoffs/BM-2166/2025-01-08_13-55-22_BM-2166_create-context-compaction.md`
        - Without ticket: `docs/handoffs/general/2025-01-08_13-55-22_create-context-compaction.md`
...
```bash
/resume_handoff docs/handoffs/BM-2166/2025-01-08_13-44-55_BM-2166_create-context-compaction.md
```
</example_response>
